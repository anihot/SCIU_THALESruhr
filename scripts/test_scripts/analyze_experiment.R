...
# Load data
df <- read_csv("data/cleaned_analysis/Wasserbaulabor_2_merged_export_cleaned.csv", show_col_types = FALSE)
...
if (nrow(activity) > 0) {
    ...
    ggsave("data/plots/experiment_detail_zoom.png", p, width = 10, height = 6, dpi = 300)
    cat("\nHigh-res plot saved to: data/plots/experiment_detail_zoom.png\n")
} else {
