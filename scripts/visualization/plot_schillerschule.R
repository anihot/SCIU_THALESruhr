...
events_file <- "data/processed/schillerschule_analysiert.csv"
...
for (i in seq_len(nrow(top_events))) {
    ...
    sensor_file <- file.path("data/processed/cleaned_analysis", paste0(station_name, "_merged_export_cleaned.csv"))
